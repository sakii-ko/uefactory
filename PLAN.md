...
> 最后更新:2026-07-08(第 2 次) · 当前阶段:**M0(骨架与冒烟渲染)** · 状态:T0.1/T0.2/T0.4 已交付,T0.3 进行中
> ⚠️ 中期 review 已出:`docs/reviews/2026-07-08-interim-feat-m0-skeleton.md`(F1 已撤回)——
> **F2/F3 是 T0.3 标记 DONE 的前置条件;T0.6/T0.7 冻结,待 M0 主体过正式 review 后再开工。**
> 节奏约束(Owner 要求):一次只推进一个任务,做完、登记、再下一个;宁可批次小,不要质量腐化。
